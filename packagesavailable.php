 ...
 <body>
     <header class="header">
         ...
         <div class="containert">
             <h3 style="position:relative;left:360px;font-family: Times New Roman,Times,serif;">Packages Available
             </h3>

             <form action="packagesavailable.php" method="Post">
                 <input type="text" name="destination" placeholder="Enter destination" style="position:relative;left:320px;top:20px;height: 40px;font-size: 16px; border-radius: 5px;
               padding-left: 30px;">
                 <div class="bg" style=" background: linear-gradient(135deg, #71b7e6, #9b59b6);
   border-radius:5.2px 5px 5.2px 5px;
   height:40px;width:30px;
   position:absolute;
   left:530.2px;top:71.2px;
   padding-left:9px;
   padding-top:9px;">
                     <!--<button style="position:relative;left: 150px;width:100%;height:100%;padding-right:20px;background: linear-gradient(135deg, #71b7e6, #9b59b6);border:none;border-radius:5px;">-->
...
if($_SERVER['REQUEST_METHOD']=='POST')
{
 ...
 $sql="select p_id,p_name,destination,days,nights,travel_mode,travel_cost,stay_cost,food_cost,total_price,details from package where destination='".$destination1."';"; 
