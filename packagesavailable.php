...
<div class="containert">
 <h3 style="position:relative;left:360px;font-family:"Times New Roman", Times, serif;">Packages Available</h3>
 ...
 <i class="fa fa-search" aria-hidden="true" style=""></i></button>
 </div>
 &nbsp;&nbsp;
