...
<div class="containert">
 ...
 <p>Name:<input type="text" name="h_name" placeholder="Enter Name" style="position:relative;left:125px;"></p><br>
 
 <p>Place:<input type="text" name="h_place" placeholder="Enter location" style="position:relative;left:129px;"></p><br><br>
 
 <p>Description:<input type="text" name="desciption" placeholder="Enter Description" style="position:relative;left:80px;"></p><br><br>
