        ...
        <div class="containert">
            ...
            <form method="post" id="insert_form">
                ...
                <div class="user-details">
                    ...
                    <table class="table"
                        style="border-radius:12px 12px 0 0; box-shadow:0 12px 5px rgba(32,32,32,0.3);position:relative;top:30px;"
                        id="item_table">
            ...
            <div class="button">
                <a href="addschedule.php"> <input class="btn btn-primary" type="button" value="Add Schedule"
