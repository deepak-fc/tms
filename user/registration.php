...
<header class="header">
  ...
  <div class="collapse navbar-collapse" id="micon">
    ...
    <li class="nav-item dropdown">
      ...
      <a class="dropdown-item" href="C:\xampp\htdocs\MCA\myproj\adminlogin.php">Admin Login</a> </li>
   </ul>
   </div>
   </div>
  </nav>
...
if($_SERVER['REQUEST_METHOD']=='POST')
{
  ...
  $psql="INSERT INTO customer(c_name,c_password,c_email,c_address,c_contact)
  VALUES('$c_name','$c_password','$c_email','$c_address','$c_contact');";
...
<!--End of Script-->
 ...
 <div class="containerf">
    ...
    <div class="content">
      <form onsubmit="return signup1()" action="registration.php" method="post">
        <div class="user-details">
          <div class="input-box">
            <span class="details">Full Name<sup>*</sup></span>
            <input type="text" id="cname" name="c_name" placeholder="Enter your name" required>
          </div>
          
          <div class="input-box">
            <span class="details">Email<sup>*</sup></span>
            <input type="text" id="cemail" name="c_email" placeholder="Enter your email" required>
          </div>
          <div class="input-box">
            <span class="details">Phone Number</span>
            <input type="text" id="cphone" name="c_contact" placeholder="Enter your number" required>
          </div>
          <div class="input-box">
            <span class="details">Password<sup>*</sup></span>
            <input type="password" id="pass" name="c_password" placeholder="Enter your password" required>
          </div>
          <div class="input-box">
        ...
        <div class="gender-details">
          ...
          <input type="text" id="address" name="c_address" placeholder="Enter Address" required >
          </div>
        </div>
        <div class="button">
