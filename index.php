    ...
    <a href="" ><img class="logo" src="TWlogo.jpg" style="height:40px;padding:2px 10px;"></a> 
						...
						<ul id="nav">
						 ...
						 <li><a href="index.php#section-2"  onclick="javascript:window.open('index.php#section-2','_self')"> About</a></li>
                                                  ...
                                                  <a class="dropdown-item" href="adminlogin.php">Admin Login</a> </li>   
	  ...
	  <h3>About Us</h3>
	   ...
	   <div class="container">		  
		 <div class="col-md-4 about-grids">
			 <h4>Our Vision</h4>
			 <p>Since inception, the growth has been phenomenal. In a short span of time, we have opened offices in prime locations in Mumbai, Pune, Thane & Nagpur.Our mission is is to focus on values over volumes and quality over quantity with absolutely honest and ethical interactions at each stage</p>
		 </div>
		 <div class="col-md-4 about-grids grid2">
			 <h4>Our Mission</h4>
			 <p>We organize a few exclusive tours to each destination annually and hence have the time and ability.We are a group of passionate & committed individuals to make your holidays memorable.</p>
		 </div>
		 <div class="col-md-4 about-grids">
			 <h4>Safety Information</h4>
			 <p>We deliver absolute quality - the finest airlines, premium coaches, stays in the most exquisite hotels.As we believe in transparency and honesty in our dealings, we guarantee that no hidden costs.</p>
		 </div>
	 </div>
</div>
