...
<div class="containert">
 ...
 <h3 style="position:relative;left:360px;font-family:Times New Roman", Times, serif;>Day <?php echo $i ?></h3>
 
 <br><br>

 <div class="user-details">
  <p>Schedule:<input type="text" name="schedule1[]" placeholder="Enter Schedule" style="position:relative;left:100px;"></p><br>
