...
.containert{
 ...
 .containert .button input{
  font-color:white;background:linear-gradient(135deg, #71b7e6, #9b59b6);
                                                     ...
                                                     height: 45px;margin: 10px 0;width: 20%;
...
<div class="containert">
 ...
 <p>Name:<input type="text" name="name" placeholder="Enter Name" style="position:relative;left:125px;"></p><br>
 
 <p>Place:<input type="text" name="place" placeholder="Enter location" style="position:relative;left:129px;"></p><br><br>
 
 <p>Description:<input type="text" name="description" placeholder="Enter Description" style="position:relative;left:80px;"></p><br><br>
 ...
 <br><br>
 <div class="button" >
          <input class="btn btn-primary" type="button" value="Add" style="position:absolute;left:200px;"></a>
 </div>  
 <div class="button" >
