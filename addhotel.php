    ...
    <header class="header">
        ...
        <div class="containert">
            ...
            <div class="user-details">
                <p>Hotel ID:<input type="text" name="name" placeholder="Enter ID" style="position:relative;left:101px;">
                </p><br>

                <p>Name:<input type="text" name="name" placeholder="Enter Name" style="position:relative;left:125px;">
                </p><br>

                <p>Place:<input type="text" name="place" placeholder="Enter location"
                        style="position:relative;left:129px;"></p><br><br>

                <p>Description:<input type="text" name="description" placeholder="Enter Description"
