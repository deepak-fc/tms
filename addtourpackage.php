...
<div class="containert">
 ...
 <p>Package id:<input type="text" name="p_id" placeholder="" value="<?php echo $n;?>" style="position:relative;left:72px;"></p><br><br>
 
 <p>Destination:<input type="text" name="destination" placeholder="Enter Destination" style="position:relative;left:100px;"></p><br>
 
 <p>Package Name:<input type="text" name="p_name" placeholder="Enter Name" style="position:relative;left:72px;"></p><br><br>
 
 <p>Days:<input type="text" name="days" placeholder="Enter number of days" style="position:relative;left:150px;"></p><br><br>
 
 <p>Nights:<input type="text" name="nights" placeholder="Enter number of nights" style="position:relative;left:138px;"></p><br><br>
 
 <p>Details:<br><textarea name="details" rows="15" cols="25" placeholder="Enter Details" style="position:relative;left:200px;"></textarea></p><br><br>
 
 <p>Mode of Travelling:<input type="text" name="travel_mode" placeholder="Enter Mode of travelling" style="position:relative;left:40px;"></p><br><br>
 
 <p>Travel cost:<input type="text" name="travel_cost" placeholder="Enter Travel cost" style="position:relative;left:107px;"></p><br><br>
 
 <p>Stay cost:<input type="text" name="stay_cost" placeholder="Enter stay cost" style="position:relative;left:120px;"></p><br><br>
 
 <p>Food cost:<input type="text" name="food_cost" placeholder="Enter food cost" style="position:relative;left:115px;"></p><br><br>
 
 <p>Total amount:<input type="text" name="total_amount" placeholder="Enter amount" style="position:relative;left:89px;"></p><br><br>
